    ...
    <header className="w-full glass-panel rounded-2xl p-6 flex flex-col md:flex-row items-center justify-between gap-6 border border-white/10 relative overflow-hidden">
      ...
      <div className="flex items-center gap-4 self-start md:self-auto">
        <div className="relative">
          ...
          <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#8CC0EB] via-[#BFDDF0] to-[#FFEBCC] border border-white/30 flex items-center justify-center relative">
            {settings.logoUrl ? (
              <img src={settings.logoUrl} alt="Lantabur" className="w-8 h-8 object-contain" referrerPolicy="no-referrer" />
            ) : (
